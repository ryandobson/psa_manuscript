---
title: "Supplemental Online Materials (S6): Summary of Extra-Pair Sex (Scenario) Models"
author: ""
...
supplemental_sections1 <- list(
  section_1 = list(m = c("SC_PRCPSMSy", "SC_HPSMSy"), #full models
                   title = "Full preregistered models reported in manuscript"),
  
  section_2 = list(m = c("SC_PRCPSM", "SC_HPSM"), #remove study 
                   title = "Removing study terms from full preregistered models"),
  
  section_3 = list(m = c("SC_PRCPSSy", "SC_HPSSy"), #remove between-woman 
                   title = "Removing between-woman terms from full preregistered models"),
  
  section_4 = list(m = c("SC_PRCPS", "SC_HPS"), #remove study and between-woman 
                   title = "Removing both study and between-woman terms from the full preregistered models"),
  
  section_5 = list(m = c("SC_PRCPSMs1", "SC_HPSMs1", #separate study 1 and study 2 models 
                 "SC_PRCPSMs2", "SC_HPSMs2"),
                   title = "Full preregistered models analyzed by study separately"),

  section_6 = list(m = c("SC_PRCPMSy", "SC_HPMSy"), #remove self
                   title = "Removing self sexual attractiveness from full preregistered models"),
  
  section_7 = list(m = c("SC_PRCP", "SC_HP"), #basic model
                   title = "Only including partner sexual attractiveness and its interactions"),
  
  section_8 = list(m = c("SC_RHPSMSy"),#raw hormone analysis with full models 
